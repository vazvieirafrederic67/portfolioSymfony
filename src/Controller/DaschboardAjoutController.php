...
class DaschboardAjoutController extends AbstractController
{

    public function daschAjoutAction($name, Request $request, CategoryRepository $categoryRepository, TechnoRepository $technoRepository, SkillRepository $skillRepository, ProjectRepository $projectRepository ){
